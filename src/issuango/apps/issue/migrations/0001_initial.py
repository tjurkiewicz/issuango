# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-04 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('key', models.SlugField()),
                ('attribute_scheme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='issue.AttributeScheme')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectRole',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='attributes', to='issue.AttributeScheme', verbose_name='Attribute schemas'),
        ),
        migrations.AddField(
            model_name='attribute',
            name='option_group',
